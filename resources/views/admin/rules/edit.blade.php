@component('admin.layouts.content',['title'=>'ویرایش مقام '])
    ...
    @slot('breadCrumb')
        ...
        @endcan
        <li class="breadcrumb-item active">صفحه ویرایش مقام</li>
    @endslot
            ...
            <!-- errors -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name"
                           placeholder="عنوان مقام را وارد کنید." value="{{old('name',$rule->name)}}">
                </div>
                <!-- name filed -->
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" name="label" id="label"
                              placeholder="توضیحات مقام را وارد کنید.">{{old('label',$rule->label)}}</textarea>
                </div>
                <!-- label filed -->
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="permissions[]" id="permissions" multiple>
                        @foreach(\App\Models\Permission::all() as $permission)
                            <option
                                value="{{$permission->id}}" {{in_array($permission->name,old('permissions',$rule->permissions->pluck('name')->toArray()) ) ? 'selected' : ''}}>{{$permission->name}}</option>
                        @endforeach
                    </select>
                </div>
                <!-- label filed -->
